        ...
        <div class="mdl-grid demo-content">
          <div class="mdl-color--white mdl-shadow--2dp mdl-cell mdl-cell--8-col mdl-grid">
            ...
            <div class="mdl-card__actions mdl-card--border">
                <i class="material-icons" style="float:left; margin-top:4px;">directions_car</i><a href="#" class="mdl-button mdl-js-button mdl-js-ripple-effect" data-upgraded=",MaterialButton,MaterialRipple">Fahrzeiten - <?php echo $ip; ?><span class="mdl-button__ripple-container"><span class="mdl-ripple"></span></span></a>
              </div>
          </div>
